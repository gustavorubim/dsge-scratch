...
% THIS FILE IS THE ONE THAT COINCIDES WITH THE DYNARE FILE IN THE
% MODELBASE!!!!
...
modnam='taylorfl20_CHANGE_MAIK_1';
parnam='jbtpar';

cofintintb1 =   .755226;
cofintinf0 = .602691;
cofintout = 1.17616; cofintoutb1 = -.972390;
...
irpinf = x(nstart-1:nprint-1,loc(endog_,'pdot0'));
irq    = x(nstart-1:nprint-1,loc(endog_,'ygap0'));
irr    = x(nstart-1:nprint-1,loc(endog_,'rs0'));
