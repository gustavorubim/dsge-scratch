...
gamma_r=0.6242;           % Taylor rule: smoothing
gamma_y=0.8385;           % Taylor rule: output growth

gamma_eta=1.9700;        % Macroprudential regulation home country: reaction to nominal credit growth
gamma_eta_s=4.6299; % Macroprudential regulation foreign country: reaction to nominal credit growth
...
exp(eta) = ((exp(s_borr)/exp(y))/(S_borr_bar/L_total_bar))^gamma_eta;
exp(eta_s) = ((exp(s_s_borr)/exp(y_s))/(S_s_borr_bar/L_s_total_bar))^gamma_eta_s;
