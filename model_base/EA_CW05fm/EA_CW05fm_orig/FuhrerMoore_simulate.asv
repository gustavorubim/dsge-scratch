...
modnam = 'FuhrerMoore.txt';
parnam = ' FuhrerMoore_par';
...
save FM_autocorr endog_ index COR Std rule
...
if      rule==1 & types==3
    ...
    irq_FM    = irq;
    irr_FM    = irr;
    %save c:\wieland_project\impulse_data\FM_Taylor_IR irpinf_FM irq_FM irr_FM
elseif rule==2 & types==3
    irpinf_FM = irpinf;
    irq_FM    = irq;
    irr_FM    = irr;
    %save c:\wieland_project\impulse_data\FM_smooth_IR irpinf_FM irq_FM irr_FM
elseif rule==3 & types==3
    irpinf_FM = irpinf;
    irq_FM    = irq;
    irr_FM    = irr;
    %save c:\wieland_project\impulse_data\FM_Gerdes_IR irpinf_FM irq_FM irr_FM
end
