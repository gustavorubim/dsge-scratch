EA_CW05fm Replication

+ last change: 2011-08-26

+ replication: IRF to monetary shock (unit shock), figure A.2. in Kuester, Wieland (2010)

+ file with the comparisson of results: EA_CW05fm_rep_results.xls 

+ file to produce original results: FuhrerMoore_simulate.m in folder labeled EA_CW05fm_orig 
  IRF can then be found in the Workspace, ACF are saved in FM_autocorr.mat

+ file to produce replicated IRF: run.m (which calls EA_CW05fm_rep.mod in folder EA_CW05fm_rep)

+ file to produce replicated ACF: EA_CW05fm_rep_ac.mod ...
