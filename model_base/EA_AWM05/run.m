...
dynare AW_Replicate_KW_IRF_rep
...
% Load original IRF
irpinf = (xlsread('\EA_AWM05_rep_results',1,'A6:A46'));
irq = (xlsread('\EA_AWM05_rep_results',1,'C6:C46'));
irr = (xlsread('\EA_AWM05_rep_results',1,'E6:E46'));
